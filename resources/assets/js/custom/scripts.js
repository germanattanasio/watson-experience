$(document).ready(function () {
  ...
  function handlerPanels() {
    dashboardPanelLeft.attr('data-state', 'collapsed');
    setTimeout(function () {
      dashboardPanelRight.attr('data-state', 'collapsed');
    }, 500);
  }
  ...
  function initialAnimation() {
    ...
    tl01
      .set(dashboardOverlay, {
        display: 'none'
      })
      .from(elGreetings, 0.5, {
        left: '+=250px',
        opacity: 0,
        repeat: 0
      }, 0)
      .from(elHeaderTitle, 0.5, {
        left: '+=250px',
        opacity: 0,
        repeat: 0
      }, 0.3)
      .from(elFooterLogos, 0.5, {
        left: '+=250px',
        opacity: 0,
        repeat: 0
      }, 0.6)
      .from(elFooterSlide, 0.5, {
        left: '+=250px',
        opacity: 0,
        repeat: 0
      }, 0.9)
      ...
      .add('pos8', 4)
      .add('pos9', 4.5)
      .from(elAppItems1_1, 0.3, {
        left: '+=50'
      }, 'pos3')
      .from(elAppItems1_2, 0.3, {
        left: '+=100'
      }, 'pos3')
      .from(elAppItems1_3, 0.3, {
        left: '+=150'
      }, 'pos3')
      .from(elAppItems1_4, 0.3, {
        left: '+=200'
      }, 'pos3')
      .fromTo(elAppStack1, 0.5, {
        left: '500px',
        top: appRow1,
        opacity: 0
      }, {
      ...
      .from(elAppItems2_1, 0.3, {
        left: '+=50'
      }, 'pos2')
      .from(elAppItems2_2, 0.3, {
        left: '+=100'
      }, 'pos2')
      .from(elAppItems2_3, 0.3, {
        left: '+=150'
      }, 'pos2')
      .from(elAppItems2_4, 0.3, {
        left: '+=200'
      }, 'pos2')
      .fromTo(elAppStack2, 0.5, {
        left: '500px',
        top: appRow2,
        opacity: 0
      }, {
      ...
      .from(elAppItems3_1, 0.3, {
        left: '+=50'
      }, 'pos1')
      .from(elAppItems3_2, 0.3, {
        left: '+=100'
      }, 'pos1')
      .from(elAppItems3_3, 0.3, {
        left: '+=150'
      }, 'pos1')
      .from(elAppItems3_4, 0.3, {
        left: '+=200'
      }, 'pos1')
      .fromTo(elAppStack3, 0.5, {
        left: '500px',
        top: appRow3,
        opacity: 0
      }, {
  ...
  function adjustDashboardApp() {
    ...
    elAppItems1_2.css({
      'left': appSizeFull + appGutterHalf
    });
    elAppItems1_3.css({
      'left': appSizeFull * 2 + appGutterHalf
    });
    elAppItems1_4.css({
      'left': appSizeFull * 3 + appGutterHalf
    });
    ...
    dashboardAppsWrapper.css({
      'width': dashboardAppsWrapperWidth,
      'height': dashboardAppsWrapperHeight,
      'top': dashboardAppsWrapperTop
    });
  }
  ...
  function dashboardAppsNavigate(direction) {
    ...
    TweenMax.to(dashboardAppContainer, dbaSlideSpeed, {
      x: xTarget,
      ease: dbaSlideMeth /* , onComplete: slideDone*/
    });
  }
